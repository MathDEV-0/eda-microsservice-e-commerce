...
public class KafkaConfig {
    private static Integer PARTITION_COUNT = 1;
    private static Integer REPLICA_COUNT = 1;
    ...
    private NewTopic buildTopic(String name){
        return TopicBuilder.name(name).replicas(PARTITION_COUNT).partitions(REPLICA_COUNT).build();
    }
